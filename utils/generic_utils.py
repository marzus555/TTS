...
def save_checkpoint(model, optimizer, optimizer_st, optimizer_rc, model_loss, out_path,
                    current_step, epoch):
...
def check_config(c):
    ...
    # dataloading
    _check_argument('text_cleaner', c, restricted=True, val_type=str, enum_list=['romanian_cleaners', 'english_cleaners', 'phoneme_cleaners', 'transliteration_cleaners', 'basic_cleaners'])
